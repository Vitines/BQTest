...
class Functions{
    ...
    function generarPDF($idPedido,$nombre,$apellido1, $apellido2, $email, $num_pedido, $producto, $num_serie, $motivo){
        ...
        //Incluimos la libreria e instanciamos un objeto de esta 'estandar': formato alargado y medido en mm y tama�o A4
    ...
    function enviaEmail($nombre, $apellido1, $apellido2, $email, $idPedido, $nombreArchivo){
        ...
        $texto = "<html><body>" . 
                    ...
                    "<p>Su reclamacion ha sido recibida con n�mero " . $idPedido . ": </p>" . 
                    "<p>En breve nos pondremos en contacto con usted </p>" . 
                    "<p>No olvide imprimir el PDF anexado para llevar a cabo la reclamaci�n. </p>" . 
